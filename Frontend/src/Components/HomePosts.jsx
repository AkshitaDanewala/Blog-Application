...
<img src={post.photo} alt="" className='w-full h-full rounded object-cover' />
...
<div className='bg-green-200 flex flex-col items-end  mb-2 text-sm font-semibold text-gray-500  md:mb-4 px-2 mt-4'>

<div className="creatornamediv">
<span>Creator Name:</span> <span className='ml-1'>@{post.username}</span>     
</div>
