...
<input type="text" placeholder='Enter Username' className='w-[70%] px-4 py-2 border-2 border-black outline-0 rounded' />
...
<button className='w-[30%] px-4 py-3 text-xl font-bold text-white bg-black rounded-lg hover:bg-gray-400 hover:text-black'>Register</button>
