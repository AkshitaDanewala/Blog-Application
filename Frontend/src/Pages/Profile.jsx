...
<div className="rightdiv md:sticky md:top-12 flex justify-start md:justify-end items-start  w-full md:w-[30%]  py-1  md:items-end bg-green-200 px-5  ">
...
<div className="btnsdiv flex items-center space-x-4 mt-8  bg-red-200">
    <button onClick={handleUserUpdate} className='bg-black text-white rounded px-4 py-2  font-semibold cursor-pointer hover:text-black hover:bg-gray-400 mb-2 '>Update</button>
    <button onClick={handleUserDelete} className='bg-black text-white rounded px-4 py-2 font-semibold cursor-pointer hover:text-black hover:bg-gray-400 mb-2'>Delete</button>
